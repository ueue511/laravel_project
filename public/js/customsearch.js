...
function SearchResult() {
  ...
  $html = ['<div class="row no-gutters modal_result_list"><div class="col-md-4"><img class="bd-placeholder-img img_modal" width="100%" height="250" src = "', book_data[book_no].item_img, '" preserveAspectRatio="xMidYMid slice" focusable = "false"></img></div > <div class="col-md-8"><div class="card-body"><h5 class="card-title title_modal" >', book_data[book_no].item_name, '</h5><p class="card-text">', book_data[book_no].caption,'</p><p class="card-text" name="item_amount" value="', book_data[book_no].item_amount,'">', book_data[book_no].item_amount, '円</p><p class="card-text" >', book_data[book_no].published, '、販売</p></div></div></div><input type="hidden" name="item_img" value="',book_data[book_no].item_img, '"><input type="hidden" name="item_name" value="',book_data[book_no].item_name,'"><input type="hidden" name="item_amount" value="', book_data[book_no].item_amount,'"><input type="hidden" name="published" value="', book_data[book_no].published,'"><input type="hidden" name="item_url" value="', book_data[book_no].item_url,'">'].join('')
